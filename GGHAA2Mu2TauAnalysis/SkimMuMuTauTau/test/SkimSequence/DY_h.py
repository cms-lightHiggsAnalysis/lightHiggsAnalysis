...
#process.load('GGHAA2Mu2TauAnalysis/SkimMuMuTauTau/hTozzTo4leptonsMuonCalibrator_cfi')
...
process.Mu45Selector = cms.EDFilter(
    ...
    hltTags = cms.VInputTag(cms.InputTag("HLT_Mu50_v3", "", "HLT2")
                            ),
    theRightHLTTag = cms.InputTag("HLT_Mu50_v3","","HLT2"),#TTBar background is v2
    #theRightHLTSubFilter1 = cms.InputTag("hltL3fL1sMu16orMu25L1f0L2f10QL3Filtered45e2p1Q","","HLT2"),#v2
    theRightHLTSubFilter1 = cms.InputTag("hltL3fL1sMu22Or25L1f0L2f10QL3Filtered50Q","","HLT2"),
...
process.TFileService = cms.Service("TFileService",
    fileName =  cms.string('TFileDYZ.root')
)
#no selection path
