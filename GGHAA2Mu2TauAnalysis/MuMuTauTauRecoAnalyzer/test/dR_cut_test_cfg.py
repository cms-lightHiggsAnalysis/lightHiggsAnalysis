...
process.Primary = cms.EDAnalyzer("PostPrimarySelectionAnalyzer",
                                 electrons = cms.InputTag("High","PassedElectron","complete"), 
                                 Taus=cms.InputTag("High","PassedTau","complete"),
                                 Cutelectrons = cms.InputTag("High","CutElectron","complete"),
                                 CutTaus=cms.InputTag("High","CutTaus","complete")
                                 )
...
# process.DiMuAnalyze = cms.EDAnalyzer("DiMuonAnalyzer",
...
process.TFileService = cms.Service("TFileService",
                                   fileName = cms.string('file:/afs/cern.ch/work/r/rhabibul/RootFiles/dR_test_checkpoint.root')
                                   )



# Configure a path and endpath to run the producer and output modules
process.p = cms.Path(process.Loose*process.High*process.Primary)
