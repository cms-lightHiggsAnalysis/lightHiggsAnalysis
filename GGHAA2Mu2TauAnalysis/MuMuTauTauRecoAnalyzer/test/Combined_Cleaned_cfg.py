...
process.TFileService = cms.Service("TFileService",
                                   fileName = cms.string('file:/afs/cern.ch/work/r/rhabibul/RootFiles/Combined_11GeV_Cleaned_DiMuPeak.root')
                                   )



# Configure a path and endpath to run the producer and output modules
process.p = cms.Path(process.Loose*process.High*process.DiMuon*process.CrossClean*process.Analyze)
