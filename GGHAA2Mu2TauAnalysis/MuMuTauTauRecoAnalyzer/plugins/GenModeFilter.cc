...
// Class:      GenModeFilter
// 
/**\class GenModeFilter GenModeFilter.cc GGHAA2Mu2TauAnalysis/MuMuTauTauRecoAnalyzer/plugins/GenModeFilter.cc
...
class GenModeFilter : public edm::stream::EDFilter<> {
   public:
      explicit GenModeFilter(const edm::ParameterSet&);
      ~GenModeFilter();
...
//
GenModeFilter::GenModeFilter(const edm::ParameterSet& iConfig):
...
// member functions
//
bool GenModeFilter::isAncestor(const reco::Candidate* ancestor, const reco::Candidate * particle)
{
...
bool GenModeFilter::isDaughter(const reco::Candidate* Daughter, const reco::Candidate * particle)
{
  //particle is already the ancestor 
...
bool GenModeFilter::isPdgMatch(const reco::Candidate * ancestor, const reco::Candidate * particle, int Id)
{
...
bool
GenModeFilter::filter(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
   using namespace std;
   ...
   cout<<" TaueTauHadPointer: " <<tethfill<<endl;
   cout<< " TaueTauHadCount : " <<teth<<endl;
...
#endif
   */
   cout<< "ele Count " <<tete<<endl;
   cout<<" Double ele count " << teteGlob<<endl;

   GoodMode=(tethfill> 0 && !DoubleEle );
   if(GoodMode)
     return true;
   else
     return false;
...
void
GenModeFilter::beginStream(edm::StreamID)
{
}

// ------------ method called once each stream after processing all runs, lumis and events  ------------
void
GenModeFilter::endStream() {
}

// ------------ method called when starting to processes a run  ------------
/*
void
GenModeFilter::beginRun(edm::Run const&, edm::EventSetup const&)
{ 
}
*/
...
/*
void
GenModeFilter::endRun(edm::Run const&, edm::EventSetup const&)
{
}
*/
...
/*
void
GenModeFilter::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
*/
...
/*
void
GenModeFilter::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
*/
...
void
GenModeFilter::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(GenModeFilter);
