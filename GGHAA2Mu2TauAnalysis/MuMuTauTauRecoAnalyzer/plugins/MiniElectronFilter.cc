...
class MiniElectronFilter : public edm::stream::EDFilter<> {
public:
      explicit MiniElectronFilter(const edm::ParameterSet&);
  ~MiniElectronFilter();
  ...
  double GsfEleMissingHitsCut(pat::ElectronCollection::const_iterator ele);
  
  double GsfEleEffAreaPFIsoCut(pat::ElectronCollection::const_iterator ele,edm::Event& iEvent);
  double GsfEleConversionVetoCut(pat::ElectronCollection::const_iterator ele,edm::Event& iEvent);
...
//
MiniElectronFilter::MiniElectronFilter(const edm::ParameterSet& iConfig):
...
MiniElectronFilter::~MiniElectronFilter()
{
...
// member functions
//
float MiniElectronFilter::dEtaInSeed (pat::ElectronCollection::const_iterator ele){
...
float MiniElectronFilter::GsfEleEInverseMinusPInverse (pat::ElectronCollection::const_iterator ele)
{
...
double MiniElectronFilter::GsfEleMissingHitsCut(pat::ElectronCollection::const_iterator ele)
{
...
/*double MiniElectronFilter::GsfEleEffAreaPFIsoCut(reco::GsfElectronCollection::const_iterator ele,edm::Event& iEvent)
{
...
*/
double MiniElectronFilter::GsfEleConversionVetoCut(pat::ElectronCollection::const_iterator ele ,edm::Event& iEvent)
{
...
void
MiniElectronFilter::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(MiniElectronFilter);
